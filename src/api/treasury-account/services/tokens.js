...
module.exports.ETH_MAINNET_TOKENS = ETH_MAINNET_TOKENS;
const OPTIMISM_MAINNET_TOKENLIST = [
  {
...
module.exports.OPTIMISM_MAINNET_TOKENLIST = OPTIMISM_MAINNET_TOKENLIST;
module.exports.OPTIMISM_MAINNET_TOKENS = OPTIMISM_MAINNET_TOKENLIST.map(e => e.address);
