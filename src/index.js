...
module.exports = {
  ...
  register({ strapi }) {
    ...
    // TODO: update list
    .excludeFromGeneration(["defi-safety-report", "section", "lore", "tweet", "term", "helper", "governance-discussion", "governance-proposal", "global", "content-type", "audit", "about", "users-permissions", "upload"]);
  },
